...
public class TransactionManager {
    ...
    /**
     * Determines the current state of a transaction. When this method is called inside a transaction it will return always the same state for a transaction
     * in order to keep the view of the current transaction consistent.
     * 
     * @param transactionId
