 ...
 * @author Kai Orend
 */
public class DataObjectDeletedEvent extends DataEvent implements MongoEvent {
     ...
     */
    public DataObjectDeletedEvent(DataModel model, Document databaseObject) {
        super(model);
    ...
    private static final Logger LOG = getLogger(DataObjectDeletedEvent.class.getName());
